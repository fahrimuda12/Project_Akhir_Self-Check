...
class SelfCheckController extends Controller
{
    ...
    public function indexQuiz()
    {
        ...
        foreach ($data_pertanyaan as $key => $value) {
            $data_pertanyaan[$key]->opsi_1 = SkalarCF::select('skalar', 'bobot_nilai')->where('kode_skalar', $value->opsi_1)->get();
            $data_pertanyaan[$key]->opsi_2 = SkalarCF::select('skalar', 'bobot_nilai')->where('kode_skalar', $value->opsi_2)->get();
            $data_pertanyaan[$key]->opsi_3 = SkalarCF::select('skalar', 'bobot_nilai')->where('kode_skalar', $value->opsi_3)->get();
            $data_pertanyaan[$key]->opsi_4 = SkalarCF::select('skalar', 'bobot_nilai')->where('kode_skalar', $value->opsi_4)->get();
            $data_pertanyaan[$key]->opsi_5 = SkalarCF::select('skalar', 'bobot_nilai')->where('kode_skalar', $value->opsi_5)->get();
            $data_pertanyaan[$key]->opsi_6 = SkalarCF::select('skalar', 'bobot_nilai')->where('kode_skalar', $value->opsi_6)->get();
        };
        // dd($data_pertanyaan);
