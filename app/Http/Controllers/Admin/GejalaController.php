...
class GejalaController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if ($result == false)
            return redirect()->route('admin.gejala.create')->with('error', 'Data Tidak berhasil ditambah');
    ...
    public function update(Request $request)
    {
        ...
        if ($result == false)
            return redirect()->route('admin.gejala.index')->with('error', 'Data Gejala Gagal Diubah');

        return redirect()->route('admin.gejala.index')->with('success', 'Data Gejala Berhasil Diubah');
    }
