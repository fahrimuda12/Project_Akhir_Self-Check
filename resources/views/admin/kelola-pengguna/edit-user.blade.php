...
@section('content')
    ...
    <div class="py-8 px-4 sm:ml-64">
        ...
        @endif
        <form action="{{ route('admin.kelola-pengguna.update-user', ['id' => $users->nrp]) }}" method="POST">
            @csrf
            @method('POST')
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="nrp" id="floating_kode" value="{{ $users->nrp }}"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                @enderror
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="pekerjaan" id="floating_pekerjaan"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <textarea name="alamat" id="floating_address" rows="4"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required> {{ $users->alamat }}</textarea>
