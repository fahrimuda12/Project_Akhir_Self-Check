    ...
    <div class="py-8 sm:ml-64">
        <section id="penyakit" class="mb-10">
            ...
            <div class="relative overflow-x-auto">
                <table id="table-penyakit" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead
                        class="text-xs md:text-sm text-gray-700 uppercase bg-zinc-50 border-none dark:bg-gray-700 dark:text-gray-400">
                        <tr>
