        ...
        <ul class="space-y-2">
            ...
            {{-- <li class="">
                <a href="https://flowbite.com/" class="flex items-center">
                    ...
                    <span
                        class="p-2 self-center text-xl font-semibold whitespace-nowrap hidden md:block dark:text-white">PENSclinic</span>
                </a>
            </li> --}}
            <li class="pb-5 pt-5">
            ...
            {{-- <li>
                <a href="{{ route('admin.kelola-data') }}"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Kelola Data</span>
                    <span
            ...
            {{-- <li>
                <a href="{{ route('admin.kelola-pengguna') }}"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Kelola Pengguna</span>
                </a>
            </li> --}}
            <li>
                <a href="{{ route('admin.kelola-pengguna') }}"
