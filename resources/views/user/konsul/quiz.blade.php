                    ...
                    <div class="card rounded-2xl mx-4 md:mx-4" style="background-color: #F6F8FD">
                        <div class="card-body px-4 md:py-8 md:px-12 lg:py-8">
                            <div class="grid grid-cols-2">
                                <div>
                                    <h1 class="text-2xl font-semibold">{{ $value->pertanyaan }}</h1>
                                        ...
                                        @if (isset($value->opsi_1))
                                            @if ($value->opsi_1->type == 'pilgan')
                                                <div
                                                    ...
                                                    <label for="jenkel"
                                                        class="md:ml-2 text-center  md:text-lg font-bold text-gray-900 dark:text-gray-300 ">{{ $value->opsi_1->skalar }}</label>
                                                </div>
                                                @if (isset($value->opsi_2))
                                                    <div
                                                        ...
                                                        <label for="jenkel"
                                                            class="md:ml-2 text-center md:text-lg font-bold text-gray-900 dark:text-gray-300">{{ $value->opsi_2->skalar }}</label>
                                                    </div>
                                                @endif
                                                @if (isset($value->opsi_3))
                                                    <div
                                                        ...
                                                        <input id="jenkel-radio" type="radio"
                                                            ...
                                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                        <label for="jenkel"
                                                            class="md:ml-2 text-center md:text-lg font-bold text-gray-900 dark:text-gray-300">{{ $value->opsi_3->skalar }}</label>
                                                    </div>
                                                @endif
                                            @elseif ($value->opsi_1->type == 'isian')
                                                <div
                                                    ...
                                                    <input type="number" name={{ 'data[' . $key . ']' . '[hari]' }}
                                                        class="bg-gray-50 border border-gray-300 text-gray-900  md:text-2xl font-bold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
